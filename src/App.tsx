        ...
        <VStack gap="8" align="stretch">
          ...
          <SimpleGrid columns={{ base: 1, lg: 3 }} gap="8">
            ...
            <Stack gap="6">
              ...
              {/* Score Card */}
              <Box bg="orange.subtle" p="8" borderRadius="2xl" textAlign="center" border="1px solid" borderColor="orange.200">
                <VStack gap="6">
                  <Heading size="md" color="orange.800">Final Verdict</Heading>
                  ...
                  >
                    ...
                    <ProgressCircle.Circle width="15px" cap="round" />
                  </ProgressCircleRoot>

                  <Text fontWeight="semibold" fontSize="lg" color="orange.900">
